...
const Footer = () => {
  ...
  const pathsWithAbsoluteFooter = ["/login", "/login-2-factor", "/login-3-factor", "/signup-confirmation"];
    ...
    <footer className={`body-font ${footerClass} bg-[#171719] text-[#83c5be]`}>
      <div className="container mx-auto flex flex-col items-center px-5 py-8 sm:flex-row">
        <a
          ...
          href="/"
        >
          <span className="ml-3 cursor-pointer text-xl text-[#83c5be]">
            Dal Vacation Home
          </span>
        </a>
        ...
        <span className="mt-4 inline-flex justify-center sm:ml-auto sm:mt-0 sm:justify-start">
          ...
          <a className="ml-3 text-[#83c5be] hover:text-yellow-500" href="/">
            <svg
              fill="currentColor"
              strokeLinecap="round"
              strokeLinejoin="round"
